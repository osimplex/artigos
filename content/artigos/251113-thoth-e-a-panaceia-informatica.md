...
A panacéia informática do momento tem suas aplicações, utilidades em potencial, tudo isso. Mas, como poderia estar descrito no Fedro, se fosse escrito hoje, a negligência com nossa a própria educação desemboca numa ironia: encostados em uma _so-called_ inteligência nos tornamos  "analfabetos enciclopédicos", capazes de ser ignorantes em tudo, e tratar de tudo sem nada entender. Computador pode ser utilizado para gerar um mar de texto, mas educação é conosco.
