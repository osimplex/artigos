...
Este vínculo, porém, não é qualquer vínculo. O direito se dá como produto da expectativa possível entre seres capazes de projetar-se no futuro e no passado pela via da unidade da vontade e da unidade do intelecto. Assim, este vínculo é uma interação possível que depende de capacidades efetivas. A dependência fundamental seria o par conjugado da capacidade da "promessa", apalavrar uma atitude futura, e do "responso", responder pela coerência da atitude passada com a "promessa".

Isso passa por um dos mistérios da vida humana, a unidade abstrata que nos permite olhar para trás e ousar apalavrar um futuro, que é tão básico que acaba esquecido. Quero dizer, os relacionamentos românticos, laborais etc estão todos fundados nessa base. Por vivência, podemos dizer que observamos a sinergia das duas menores unidades se dando por força do vínculo descrito.

Aqui não estamos propondo que o ordenamento legal de um Estado-Nação seja o produto direto da relação intra-familiar ou comunitária local de cada um. Isso seria ignorar inúmeras estruturas abstratas que verificamos conforme cresce a complexidade social, o próximo com o remoto, ainda que seja possível algum grau de analogia. Antes, queremos dizer que da menor unidade numa sociedade humana emerge uma forma próxima (não remota) de direito, característica do ser humano enquanto ser social, que persiste até os limites concretos da capacidade de interação das menores unidades pelo primeiro critério. O que envolve um salto qualitativo; para variar, sem resolução simples.

Com outra linguagem resumimos: _o direito é uma função do vínculo_, ou uma estrutura abstrata de articulação entre indivíduos.
...
Iniciemos com uma provocação: _propriedade intelectual não existe_, é um pseudoconceito. Porém deve-se reconhecer que existe direito de patentes, marcas além do direito autoral e outras situações como topologia de circuito integrado, cultivares etc.

O termo _propriedade intelectual_, ainda que seja recorrente no _status quo_, na doutrina, é um contrassenso, e mistura realidades jurídicas bem distintas por uma característica que não é compartilhada. Para começarmos a construir algum entendimento, convém afastar o pseudoconceito e entender os verdadeiros conceitos.
...
O termo _propriedade intelectual_ peticiona que o objeto de propriedade é uma realidade intelectual. O que não é coerente com o conjunto de realidades legais que estão sob o guarda-chuva.

O gênero mais apropriado para toda a categoria, no meu ver, seria a de bens intangíveis, como se observa num plano de contas em contabilidade, mais especificamente entre as chamadas contas devedoras. A questão não é intelecto, especialmente em direito de marcas, que cobre registros puramente nominativos inclusive, para proteger nomes comerciais que podem não ser originados por grandes investimentos intelectuais, mas o direito de exploração exclusiva de uma realidade imaterial. Daí podemos conceder, no limite, o termo propriedade imaterial, mas sempre retornando às respectivas filosofias de cada direito da categoria, distintas das demais realidades no escopo do _direito das coisas_, bens materiais móveis ou imóveis. Ainda considerando que, no meu ver, o objeto de propriedade seja a outorga. Esta outorga social pode ser respeitada ou violada.

### Direito autoral

O direito autoral é o direito primeiro em que se enquadra o _software_. Patentes aplicáveis ao _software_ existem em algumas jurisdições, não trataremos disso, mas é antes algo a que um _software_ pode estar sujeito, o uso de patente, do que a categoria para enquadrar o _software_.
...
Mas o direito autoral não nasceu visando esse aspecto da realidade humana. Ou melhor dizendo, o _direito de cópia_, ou _copyright_, como dizem os gringos.

O _direito de cópia_ nasceu sob a Coroa Britânica algum tempo depois da invenção da imprensa, como uma forma de restringir que literatura poderia ser impressa. Isto é: se tratava de uma regulação das "plataformas de difusão" da época. Em movimentos anteriores houve a Lei dos Impressores e Encadernadores de 1534, por exemplo, que regulava importação de obras e concedia poder de tabelamento de preços de livros.

O marco inicial deste processo foi a incorporação da Guilda dos Impressores pela Coroa inglesa no ano de 1557, estabelecendo um monopólio da _prensa_, do direito de copiar. A Guilda também tinha o direito de confiscar obras ilícitas.

Em 1662 houve a Lei de Licenciamento da Prensa, que continuou o movimento, e tinha a seguinte descrição: "_An Act for preventing the frequent Abuses in printing seditious treasonable and unlicensed Books and Pamphlets and for regulating of Printing and Printing Presses_". Em uma tradução livre: "Uma lei contra os abusos frequentes na impressão de livros e panfletos sediciosos, traidores e não licenciados, e para regulamentar a Prensa". Esta lei estabeleceu a responsabilidade de órgão censor da Guilda dos Impressores, associada com a obrigação de registrar junto à Guilda qualquer obra para obter o _direito de copiar_. Esta lei tinha uma cláusula de validade, e era necessário renovação parlamentar a cada 2 anos. Na sequência de protestos motivados pelos efeitos do poder censório, o parlamento se recusou a renovar a lei em 1694.

Entre as iniciativas da Guilda para recuperar sua posição, adotou-se uma nova posição tática, esta sim, de relativa proximidade com o _direito de cópia_ moderno. Tirando o foco da impressão e publicação, argumentou-se que os autores deveriam ter direitos sobre as respectivas obras. Esta posição foi aprovada no parlamento sob a forma do Estatuto da Rainha Ana em 1710. Aparte a querela dos livreiros, que disputou os direitos sobre obras anteriores ao Estatuto.

Este Estatuto que se apresentava como "uma lei para encorajamento do aprendizado" introduziu figuras como o "detentor dos direitos", pois o direito de cópia que anteriormente pertencia à Guilda passou a ser concedido, em primeiro, ao autor após o processo de registro e depósito de cópias da obra, e então este direito de cópia poderia ser _licenciado_, concedido a terceiros. E este direito incluía o controle sobre a impressão e reimpressão de livros. Na Inglaterra o registro compulsório das obras vigorou até 1923.

Isso falando somente da história britânica, mas que é importante citar por seu papel precursor. Vale lembrar que cada território, cada _jurisdição_ tem história própria com detalhes particulares.

Mas, se com a prensa houve o nascimento e a evolução da noção de _direito de cópia_, com o surgimento da possibilidade de gravar e reproduzir sons, e da indústria fonográfica, tivemos a ampliação de escopo destes direitos para a música. E hoje o escopo do _copyright_ alcança as mais diversas formas de expressão humana, _software_ inclusive.
...
Cabe a nota de que o aspecto do direito moral do autor não é universal. Mas é uma realidade no ordenamento legal brasileiro.
...
Em sociedade, essa produção humana está, com algumas particularidades que derivam da natureza da coisa, sob o guarda-chuva do direito autoral. Por vezes contando também com legislação própria, podendo ou não ser objeto de patente, de acordo com a jurisdição.
...
Em termos estritos, para a licença ser de _software_ livre é necessário somente a aderência às quatro liberdades, mas dada a complexidade de analisar legalmente cada licença, a aceitação institucional da FSF assegura a aderência às liberdades.
...
Se qualquer articulação define algum grau de liberdade, não faz sentido defender "a liberdade", com artigo definido antes do substantivo. É equívoco. Para sanar o equívoco é necessário fixar um critério estrutural. E isso é claramente fornecido pela FSF. Quando se falar em liberdade de _software_, portanto, não há equívoco: trata-se da amplitude de movimento possível dadas as quatro liberdades postuladas pela FSF. Formuladas num contexto de cultura _hacker_.

Acolher ou afastar esse parâmetro é uma decisão particular, e, naturalmente, dependerá de critérios particulares. E aí um outro benefício: dada a clareza, é possível a aplicação acertada de critérios e o julgamento. O que depende da pergunta fundamental: "o que eu quero?". De cada objeto do querer há aquelas coisas que nos aproximam, e aquelas que nos afastam.
...
Também devemos fazer a mesma ressalva que fizemos quanto ao _software_ livre. Em termos estritos, para a licença ser de código aberto é necessário somente a aderência aos dez critérios da OSI, mas dada a complexidade de analisar legalmente cada licença, a aceitação institucional da OSI assegura a aderência aos referidos critérios.
...
Também é importante esclarecer que nenhuma das proposições, nem a da OSI, nem a da FSF, afastam a possibilidade de comércio. Bem pelo contrário, a OSI tem um propósito bem voltado para o meio corporativo, e tem critérios claros de não discriminação de uso, e a FSF, voltada para a liberdade _do usuário_, é bastante clara em estabelecer que o uso comercial faz parte dessas liberdades. Um _slogan_ do _software_ livre resume isso bem:

> Free as in freedom, not as in free beer.

_Software_ livre é sobre liberdade, não sobre _software_ gratuito. O _slogan_ é direcionado para sanar uma ambiguidade que existe em inglês, mas em português também deixamos claro do que se trata.
...
Licenças _Creative Commons_ são próprias para obras literárias, artísticas e assim por diante. Para _software_ há licenças mais próprias, específicas, que endereçam detalhes que não são compartilhados por outras criações que fazem parte do escopo do direito autoral. A própria organização responsável pelas licenças CC [não recomenda](https://web.archive.org/web/20260901052435/https://creativecommons.org/faq/#can-i-apply-a-creative-commons-license-to-software) que se use qualquer de suas licenças para _software_.
...
Não proponho, pessoalmente, que _copyleft_ é uma bala de prata, e que deve ser aplicada em todo e qualquer licenciamento. Mas a primeira questão para a retórica da detração é: como isso pode se dar? Sabemos que toda obra autoral ["nasce"]({{< relref "260831-gnus-preparados-p2#estado-de-natureza" >}}) não-livre, e que o _copyleft_ não é critério para definir se algo é ou não é livre, e nem de código aberto. Antes, qualquer licença _livre_, contando com _copyleft_ ou não, estabelece plenamente a liberdade de _software_. _Simili modo_ quanto ao código aberto.

A retórica dos detratores exige, implicitamente, a aceitação de algo que não faz parte dos conceitos fundamentais: um parâmetro adicional de liberdade determinado de forma negativa: "não-_copyleft_". Esse parâmetro negativo pode ser classificado como uma rejeição específica de obrigações associadas ao exercício da liberdade de distribuição, ainda que licenças aprovadas pela FSF e pela OSI possam incorporar tais obrigações desde que não contradigam liberdades (FSF)/critérios (OSI), de modo que não sejam restrição, mas _condição_ de exercício de uma dada liberdade. _Copyleft_ é um exemplo disso, mas não o único.

Na GPLv3 podemos verificar a obrigação de oferecer ao recipiente de um _software_ distribuído na forma de código-objeto (executável compilado) um meio de obter o respectivo código fonte, a obrigação de fornecer todos os avisos de licenciamento e a licença ao recipiente de uma cópia verbatim do código fonte. Mais ainda, em licenças ditas "permissivas" frequentemente encontramos obrigações associadas à distribuição, como a reprodução do aviso de direitos autorais, das cláusulas, aviso de garantia e limitação de responsabilidade que verificamos na BSD de três cláusulas (essa é uma de três, naturalmente). Se o mero estabelecimento de obrigações acessórias fosse problema, constituísse "restrição às liberdades", teria de se admitir que isso afeta licenças minimalistas também.

O fundamento dos detratores é um interesse material. Em termos diplomáticos, a liberdade de não-reciprocidade. O _copyleft_ é o instrumento pelo qual um detentor de direitos concede liberdade de _software_ para todos os que tiverem contato com a obra (pensamento ligado ao _software_ livre), ou a preservação das condições do modo de produção do _software_ (pensamento ligado ao código aberto), de forma indireta. A concessão direta se dá no licenciamento, a indireta no _copyleft_. Liberdade por legado. O que deve ser afastado na visão da não-reciprocidade.

Com uma obrigação de _copyleft_ não é possível se apropriar da obra de um terceiro, construir sobre ela, e distribuir este trabalho derivado sem conceder aos usuários as mesmas liberdades que possibilitaram a construção desta obra derivada. É por isso que a retórica dirá que isso torna o licenciamento "menos livre" e desfavorece "o desenvolvedor", faltando dizer qual. Então a última questão é: porque é ilegítimo que o autor estabeleça liberdade de _software_ para quem recebe indiretamente sua produção autoral?

### _Copyleft_ e o desenvolvedor

Adicionando cores à questão do desenvolvedor, a possibilidade de redistribuição com restrições à liberdade dos usuários, interesse da retórica anti-_copyleft_, é defendida em nome dos negócios. Mas em nome dos negócios também podemos ir em favor das obrigações associadas às liberdades, e aqui cito o caso do Redis. Um banco de dados NoSQL bastante interessante, _software_ livre e de código aberto do ponto de vista de licenciamento, BSD, que acabou tornado não-livre, disponibilizado sob as licenças SSPLv1 e RSALv2 num modelo de _código disponível_ [desde a versão 7.4](https://redis.io/blog/redis-adopts-dual-source-available-licensing), pela empresa detentora dos direitos para enfrentar um uso comercial em larga escala sem contrapartida de fornecedoras de computação "em nuvem". Onde ficou o desenvolvedor?

As licenças adotadas, para ser completo, não são aceitas pela FSF, e nem pela OSI. Então o Redis deixou de ser projeto de código aberto também.
...
Pessoalmente, já testemunhei violações inclusive de cláusula de licenças minimalistas por parte de empresa que fatura seus humildes bilhõezinhos. Como se custasse replicar o aviso de direitos (_copyright notice_) do _software_. Mas neste departamento, via de regra, ninguém vai atrás de exigir a execução dos termos da licença. Diferente do terreno do _copyleft_, em que há preocupação com a manutenção das intenções do detentor de direitos expressas na licença.

Ainda assim é necessário dizer: _copyleft_ não é bala de prata. Violação de licença acontece, e lidar com isso de forma produtiva não é simples. Dizem que o licenciamento é tão forte quanto o time de advogados que se pode contratar para fazê-lo valer. Quando falamos de projetos que não são promovidos por atores corporativos, por vezes é necessário um esforço que transcende bastante as capacidades individuais dos envolvidos.

Uma outra situação é a chamada incompatibilidade de licenças. Este artigo não se propõe a analisar legalmente licenças, mas duas peças podem ser ou não ser legalmente combináveis. Um caso notório é o módulo que fornece sistema de arquivos ZFS para _kernel_ Linux; as peças, módulo OpenZFS e Linux, estão sob licenças _copyleft_ e incompatíveis CDDLv1 e GPLv2, respectivamente. Este já não é um tópico retórico de detratores, mas uma situação com a qual deve se lidar ao utilizar código sob licença com _copyleft_. O que nos leva de volta ao comentário sobre licenças minimalistas, o ponto forte delas é a simplicidade legal, e frequentemente são adotadas por isso.

Arrematando a questão, o _copyleft_ expressa uma intenção legítima que não contraria a liberdade de _software_ e a produção de código aberto. Pode não ser uma intenção que pertence a todos que produzem _software_, nem a todos que se beneficiam, mas sendo este o caso há liberdade civil para aplicar a licença que achar melhor (sendo detentor de direitos), ou simplesmente não contrair a obrigação, buscando uma outra peça de _software_ sob um outro licenciamento que apeteça, ou desenvolvendo algo próprio. Uma outra possibilidade é negociar com quem detém os direitos uma outra condição de licenciamento.

Para cada necessidade e intenção há um licenciamento apropriado.
